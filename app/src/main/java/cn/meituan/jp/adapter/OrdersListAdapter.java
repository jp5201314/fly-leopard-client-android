...
public class OrdersListAdapter extends BaseRecyclerAdapter<OrderEntity> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ViewHolder) {
           ...
           ((ViewHolder) holder).tvFoodNum.setText(orderEntities.getAmount()+"");
            ...
            ((ViewHolder) holder).btnAddOrder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(context, "再来一单", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
